...
function saveToLocalStorage(){
  ...
  localStorage.setItem("playgroundsList", JSON.stringify(playgroundsList));
  localStorage.setItem("reservationsList", JSON.stringify(reservationsList));
}

// Loading the Data for JSON File //
function loadFromLocalStorage(){
  usersList = JSON.parse(localStorage.getItem("usersList"));
  playgroundsList = JSON.parse(localStorage.getItem("playgroundsList"));
  reservationsList = JSON.parse(localStorage.getItem("reservationsList"));
}
...
function getPlaygroundDetails(id) {
  let playground = playgroundsList.find(pg => pg.id == id);
...
function bookPlayground(id, hours) {
  ...
  console.log("hours booked", hours);
  hours.forEach(hour => {
    playground.reservedHours.push(hour);
  });
  console.log("plaground after booking", playground);
